Here is a revised version of the project template, adapted specifically for a beginner-friendly **Node.js (Express)** stack.

This setup unifies the language (JavaScript/TypeScript) across the entire stack, significantly reducing the learning curve for your daughter while maintaining professional standards.

### **Changes from the previous version:**

1.  **Backend:** Switched from Java/Spring Boot to **Node.js/Express**.
2.  **Migrations:** Switched from Liquibase to **Knex.js**. Knex is the standard JavaScript "Query Builder," but it also has a fantastic migration tool that works very similarly to Liquibase but uses JavaScript code instead of XML.
3.  **Storage:** Updated the S3 implementation to use the JavaScript AWS SDK and **Multer** (standard middleware for handling file uploads in Node).

-----

# Project Prompt Template: Full Stack JavaScript

Use this template to kick off a ReactJS + Node.js application. This stack uses **JavaScript (or TypeScript)** for both the frontend and backend, making it ideal for learning full-stack development without context-switching between languages.
